...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.shipping_name'
        db.alter_column('checkout_order', 'shipping_name', self.gf('django.db.models.fields.CharField')(max_length=240))

        # Changing field 'Order.shipping_city'
        db.alter_column('checkout_order', 'shipping_city', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Order.shipping_address_2'
        db.alter_column('checkout_order', 'shipping_address_2', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Order.shipping_address_1'
        db.alter_column('checkout_order', 'shipping_address_1', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Order.shipping_country'
        db.alter_column('checkout_order', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Order.shipping_name'
        db.alter_column('checkout_order', 'shipping_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.shipping_city'
        db.alter_column('checkout_order', 'shipping_city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.shipping_address_2'
        db.alter_column('checkout_order', 'shipping_address_2', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.shipping_address_1'
        db.alter_column('checkout_order', 'shipping_address_1', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.shipping_country'
        db.alter_column('checkout_order', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=50))
