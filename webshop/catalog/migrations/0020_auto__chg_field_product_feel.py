...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.feel'
        db.alter_column('products', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.FeelName'], null=True))

    def backwards(self, orm):

        # Changing field 'Product.feel'
        db.alter_column('products', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(default='null', to=orm['catalog.FeelName']))
