...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('brand_name', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('catalog', ['BrandName'])

        # Adding unique constraint on 'BrandName', fields ['name']
        db.create_unique('brand_name', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'BrandName', fields ['name']
        db.delete_unique('brand_name', ['name'])

        # Deleting model 'BrandName'
        db.delete_table('brand_name')
