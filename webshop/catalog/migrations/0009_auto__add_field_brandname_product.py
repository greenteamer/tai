...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('brand_name', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.Product'], blank=True),
                      keep_default=False)
    ...
    models = {
        'catalog.brandname': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']", 'blank': 'True'})
        },
        'catalog.category': {
