...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ColorName'
        db.delete_table('color_product')
        ...
        # Deleting field 'Product.colorName'
        db.delete_column('products', 'colorName_id')

        # Adding field 'Product.feel'
        db.add_column('products', 'feel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.FeelName']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'ColorName'
        db.create_table('color_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('catalog', ['ColorName'])

        # Deleting model 'FeelName'
        db.delete_table('Feel_product')

        # Adding field 'Product.colorName'
        db.add_column('products', 'colorName',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.ColorName']),
                      keep_default=False)
    ...
    models = {
        'catalog.brandname': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name',),)", 'object_name': 'BrandName', 'db_table': "'brand_name'"},
        ...
        'catalog.product': {
            ...
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.BrandName']"}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['catalog.Category']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'feel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.FeelName']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
