...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.BrandName']),
                      keep_default=False)

        # Deleting field 'BrandName.product'
        db.delete_column('brand_name', 'product_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BrandName.product'
        db.add_column('brand_name', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='default', to=orm['catalog.Product'], blank=True),
                      keep_default=False)
