...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.articul'
        db.alter_column('products', 'articul', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.articul'
        db.alter_column('products', 'articul', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'articul': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
