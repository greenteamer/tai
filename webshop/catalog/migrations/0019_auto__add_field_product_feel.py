...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products', 'feel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.FeelName'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'feel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.FeelName']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
